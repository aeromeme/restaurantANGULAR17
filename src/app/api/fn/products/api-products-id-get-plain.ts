...
export function apiProductsIdGet$Plain(http: HttpClient, rootUrl: string, params: ApiProductsIdGet$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<ProductDto>> {
