...
export function apiProductsIdGet$Json(http: HttpClient, rootUrl: string, params: ApiProductsIdGet$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<ProductDto>> {
