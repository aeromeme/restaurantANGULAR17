...
export function apiProductsGet$Json(http: HttpClient, rootUrl: string, params?: ApiProductsGet$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ProductDto>>> {
